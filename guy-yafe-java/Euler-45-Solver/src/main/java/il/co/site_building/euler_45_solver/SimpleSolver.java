...
public class SimpleSolver {
  ...
  public static void main(String... args) {
    ...
    Map<Long, Long> foundPairs = new HashMap<>();

    findEuler45(MAX_VALUE_TO_CALCULATE, foundPairs);
  ...
  private static void findEuler45(long max, Map<Long, Long> foundPairs) {
    ...
    for (long h = 0; h < max; h++) {
      ...
      if (pentagonalBuckets.containsKey(hexagonal)) {
        System.out.println(
            ...
            " Pentagonal: " + foundPairs.get(hexagonal) + " Hexagonal: " + h);
      }
    }
  }
